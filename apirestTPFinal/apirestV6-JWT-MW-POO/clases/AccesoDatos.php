...
class AccesoDatos
{
    ...
    {
        try { 
            $this->objetoPDO = new PDO('mysql:host=fdb21.awardspace.net:3306;dbname=2770380_sala;charset=utf8', '2770380_sala', 'Distecna123', array(PDO::ATTR_EMULATE_PREPARES => false,PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
